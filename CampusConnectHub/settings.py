"""
Django settings for CampusConnectHub project.
...
SECRET_KEY = 'django-insecure-s&_)j9^dkp*ow%38o0h@l@h##un!9+)u4!%%$^aty(gr#5=+ty'
...
ROOT_URLCONF = 'CampusConnectHub.urls'
...
WSGI_APPLICATION = 'CampusConnectHub.wsgi.application'
